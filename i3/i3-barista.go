...
func main() {
	material.Load(home(".dotfiles/fonts/material-design-icons"))
	mdi.Load(home(".dotfiles/fonts/MaterialDesign-Webfont"))
	typicons.Load(home(".dotfiles/fonts/typicons.font"))
	ionicons.LoadMd(home(".dotfiles/fonts/ionicons"))
	fontawesome.Load(home(".dotfiles/fonts/Font-Awesome"))
